...
public class RestoreOrganization extends BaseClass {
	@Test
	public void testRestoreOrganization() {
		Reporter.log("RestoreOrganization", true);
		...
		Reporter.log("slected Organizations option", true);
		s1.selectByVisibleText("Organizations");
		int count1=r.getCurrentpagereq().size();
		Reporter.log("selected Organization checkbox", true);
