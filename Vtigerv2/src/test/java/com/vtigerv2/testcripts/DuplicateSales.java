...
public class DuplicateSales extends BaseClass {
	@Test
	public void testDuplicateSales() throws InterruptedException {
	   ...
	   s.getDuplicatebtn().click();
	   //Click on Save
	   s.getSavebtn().click();
	   Reporter.log("Duplicate sales is created",true);
	}
}
