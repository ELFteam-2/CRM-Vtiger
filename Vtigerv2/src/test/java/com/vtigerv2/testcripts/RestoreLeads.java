...
public class RestoreLeads extends BaseClass {
	@Test
	public void testRestoreLeads() {
		Reporter.log("RestoreLeads", true);
		...
		Reporter.log("selected Leads option", true);
		s1.selectByVisibleText("Leads");
		int count1=r.getCurrentpagereq().size();
		Reporter.log("selected Lead checkbox", true);
