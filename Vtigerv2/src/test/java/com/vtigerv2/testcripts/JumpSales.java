...
public class JumpSales extends BaseClass {
	@Test
	public void testJumpSales() throws InterruptedException {
	   ...
	   //Click on Jump Icon 
	   s.getJumpicon().click();
	   //Click on a Different Sales Order from the Pop up.
	   s.getSalesorder().click();
	   Reporter.log("salesorder is Jumped another sales order",true);
	}
}
