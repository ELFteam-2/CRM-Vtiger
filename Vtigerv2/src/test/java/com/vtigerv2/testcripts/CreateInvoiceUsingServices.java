...
public class CreateInvoiceUsingServices extends BaseClass{
	@Test
	public void testCreateInvoiceUsingServices() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
	    ...
	    cni.getAddservicesbtn().click();
	    cni.getServicesicon().click();
	    Thread.sleep(3000);
	    ...
	    cni.getQty2().sendKeys(qty);
	    Thread.sleep(3000);
	    cni.getArrowicon().click();
	    cni.getDeleteicon().click();
	    Reporter.log("Click on Save Button",true);
	    cni.getSavebtn().click();
	    Thread.sleep(3000);
	    Reporter.log("Invoice is Created Using Services",true);
	}
}
