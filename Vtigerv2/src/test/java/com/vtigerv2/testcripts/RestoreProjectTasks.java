...
public class RestoreProjectTasks extends BaseClass {
	@Test
	public void testRestoreProjectTasks() {
		Reporter.log("RestoreProjectTasks", true);
		...
		Reporter.log("selected Project Tasks option", true);
		s1.selectByVisibleText("Project Tasks");
		int count1=r.getCurrentpagereq().size();
		Reporter.log("clicked on Project Task checkbox", true);
