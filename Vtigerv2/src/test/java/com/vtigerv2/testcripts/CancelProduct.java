...
public class CancelProduct extends BaseClass
{
	@Test
	public void testCancelProduct() throws EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String ProductData=f.getExceldata("Sheet1", 1, 4);
