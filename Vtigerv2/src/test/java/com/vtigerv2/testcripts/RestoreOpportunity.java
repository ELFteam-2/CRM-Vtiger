...
public class RestoreOpportunity extends BaseClass {
	@Test
	public void testRestoreOpportunity() {
		Reporter.log("RestoreOpportunity", true);
		...
		Reporter.log("selected Opportunities option", true);
		s1.selectByVisibleText("Opportunities");
		int count1=r.getCurrentpagereq().size();
		Reporter.log("selected Opportunities checkbox", true);
