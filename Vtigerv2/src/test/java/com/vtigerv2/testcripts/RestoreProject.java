...
public class RestoreProject extends BaseClass {
	@Test
	public void testRestoreProject() {
		Reporter.log("RestoreProject", true);
		...
		Reporter.log("selected Projects option", true);
		s1.selectByVisibleText("Projects");
		int count1=r.getCurrentpagereq().size();
		Reporter.log("clicked on Project checkbox", true);
